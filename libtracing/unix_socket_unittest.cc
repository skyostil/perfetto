...
#include "libtracing/unix_socket.h"

#include <stdio.h>
#include <sys/mman.h>

#include "gtest/gtest.h"
#include "libtracing/build_config.h"


namespace perfetto {
namespace {

// Mac OS X doesn't support abstrack (i.e. unnamed) sockets.
...
// and the othe end just doing a recv (without taking it), the fd is closed and
// not left around.

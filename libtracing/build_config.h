...
#ifndef LIBTRACING_BUILD_CONFIG_H_
#define LIBTRACING_BUILD_CONFIG_H_

// Allows to defined build flags that give a compiler error if the header that
...
#define BUILDFLAG_DEFINE_OS_LINUX_DESKTOP() 0
...
#define BUILDFLAG_DEFINE_OS_ANDROID() 0
#define BUILDFLAG_DEFINE_OS_MACOSX() 0
#define BUILDFLAG_DEFINE_OS_LINUX_DESKTOP() 1
#else
#error OS not supported (see build_config.h)
#endif

#endif  // LIBTRACING_BUILD_CONFIG_H_

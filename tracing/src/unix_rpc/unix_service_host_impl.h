...
#ifndef TRACING_SRC_UNIX_RPC_UNIX_SERVICE_HOST_IMPL_H_
#define TRACING_SRC_UNIX_RPC_UNIX_SERVICE_HOST_IMPL_H_
...
#endif  // TRACING_SRC_UNIX_RPC_UNIX_SERVICE_HOST_IMPL_H_

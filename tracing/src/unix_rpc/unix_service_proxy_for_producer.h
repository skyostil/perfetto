...
#ifndef TRACING_SRC_UNIX_RPC_UNIX_SERVICE_PROXY_FOR_PRODUCER_H_
#define TRACING_SRC_UNIX_RPC_UNIX_SERVICE_PROXY_FOR_PRODUCER_H_
...
#endif  // TRACING_SRC_UNIX_RPC_UNIX_SERVICE_PROXY_FOR_PRODUCER_H_
